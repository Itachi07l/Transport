        ...
        <hr />
            <div className='flex flex-col md:flex-row mb-10 relative z-2 '>
                <div className='w-full md:w-[70%] px-2'>
                    <h1 className='text-5xl lg:text-[9rem] xl:text-[11rem] 2xl:text-[16rem] md:mb-10 ml-8'>Transport</h1>
                    <p className='text-2xl mt-5 md:mt-1 md:text-6xl text-end text-gray-800'>The creative  <br /> development studio </p>
                </div>
                {/* <div className='w-full p-5  md:w-[30%] mt-10 md:mt-30 tracking-tight'>
                    <p className='text-3xl md:text-4xl flex items-start text-gray-800 tracking-tight font-semibold'><img src="/footer/img1.svg" alt="" className='w-5 aspect-square object-contain' />&nbsp; we are current based on india and work remotely.</p>
            ...
            <div className='flex text-gray-700 flex-col md:flex-row'>
                <div className='text-2xl md:text-3xl tracking-tighter pl-10 mt-20 md:w-92'>
                    <a href="/about">
                    <p className='mb-3 '>
                ...
                <div className='text-2xl md:text-3xl tracking-tighter pl-10 mt-20 w-[32rem]'>
                    <p className='mb-3 '>
                        <span className='inline-block border-b-2 border-orange-500 pb-0.5'>P</span>rivacy policy
                    </p>
                    <p className='mb-3 '>
                        <span className='inline-block border-b-2 border-orange-500 pb-0.5'>T</span>erms service
                    </p>
                    <p className='mb-3 '>
                        <span className='inline-block border-b-2 border-orange-500 pb-0.5'>D</span>isclaimer
                    </p>
                    <p className='mb-3 '>
                        <span className='inline-block border-b-2 border-orange-500 pb-0.5'>4</span>04
                    </p>
                 
                </div>
                <div className=' border-l-1 border-r-1 bg-gray-100 border-gray-400 p-10 '>
                    <h2 className='text-4xl md:text-5xl font-semibold mt-10 mb-6'>Stay in the Loop</h2>
                ...
                <div className='text-2xl md:text-3xl tracking-tighter  w-[40rem] group '>
