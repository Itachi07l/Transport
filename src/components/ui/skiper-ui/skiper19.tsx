...
const Skiper19 = () => {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto flex h-[320vh] w-auto flex-col items-center overflow-hidden bg-[#FAFDEE] px-4 text-[#1F3A4B]"
    >
      <div className="mt-42 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
        <h1 className="font-jakarta-sans relative z-10 text-7xl font-medium tracking-[-0.08em] lg:text-9xl">
          Get Started <br /> Transportation <br />
          with Logio
        </h1>
      ...
      {/* <div className="rounded-4xl font-jakarta-sans w-auto translate-y-[200vh] bg-[#1F3A4B] pb-10 text-[#FAFDEE]">
