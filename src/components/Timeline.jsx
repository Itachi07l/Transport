  ...
  return (
    <div
      ...
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p
          className="text-neutral-700 dark:text-neutral-300 text-sm md:text-2xl max-w-sm">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[6px] bg-gradient-to-t from-purple-500 via-blue-500 to-transparent from-[0%] via-[40%] rounded-full" />
        </div>
      </div>
    </div>
  );
